...
<div class="container">
            <?php
                for ($r=0; $r < count($paginaArtista); $r++) {
                    foreach ($paginaArtista[$r] as $llave => $columna) {
                        switch ($llave) {
                            case 'imagenFondoPA':
                                $imagenFondoPAV = $columna;
                                break;
                            case 'imagenArtistaPA':
                                $imagenArtistaPAV = $columna;
                                break;
                            case 'nombrePA':
                                $nombrePAV = $columna;
                                break;
                            case 'descripcionPA':
                                $descripcionPAV = $columna;
                                break;
                            case 'albumPA':
                                $albumPAV = $columna;
                                break;
                            case 'imagenAlbumPA':
                                $imagenAlbumPAV = $columna;
                                break;
                            case 'cancion':
                                $cancionPAV = $columna;
                                break;
